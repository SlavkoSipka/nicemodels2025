  ...
  if (loading) {
    return (
      <>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-6 pb-[calc(15rem+env(safe-area-inset-bottom,0px))] md:pb-32">
  ...
  return (
    <>
      ...
      <div className="h-screen overflow-hidden bg-gradient-to-br from-gray-50 via-pink-50 to-purple-50 flex flex-col">
        {/* Generous bottom padding (+ safe-area) so FINISH stays above fixed OnboardingFooter on phones */}
        <div className="flex-1 overflow-y-auto px-4 pt-4 pb-[calc(15rem+env(safe-area-inset-bottom,0px))] md:pb-32 flex justify-center min-h-0">
