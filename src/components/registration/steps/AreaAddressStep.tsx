...
export default function AreaAddressStep({ data, updateData, nextStep, prevStep, currentStep, totalSteps }: Props) {
  const t = useTranslations('components.modelRegistration.areaAddress')
  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-6 py-8 max-w-4xl">
        ...
        <h3 className="font-semibold mb-3 mt-6">{t('deutschschweiz')}</h3>
        ...
        <h3 className="font-semibold mb-3 mt-6">{t('romandie')}</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        ...
        <h3 className="font-semibold mb-3 mt-8">{t('exactLocation')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
            ...
            >
              ...
              <option value="zurich">{t('cities.zurich')}</option>
              <option value="geneva">{t('cities.geneva')}</option>
              <option value="basel">{t('cities.basel')}</option>
              <option value="bern">{t('cities.bern')}</option>
              <option value="lausanne">{t('cities.lausanne')}</option>
              <option value="lucerne">{t('cities.lucerne')}</option>
            </select>
          </div>
          <div>
            <input
        ...
        <h3 className="font-semibold mb-3 mt-8">{t('addressDetails')}</h3>
        <div className="mb-4">
          <input
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="md:col-span-2">
            <input
              ...
              className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500"
            />
            <p className="text-xs text-gray-500 mt-1">{t('streetHint')}</p>
          </div>
          <div>
            <input
              type="text"
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500"
          />
          <p className="text-xs text-gray-500 mt-1">{t('additionalHint')}</p>
        </div>

        <h3 className="font-semibold mb-3 mt-8">{t('availableFor')}</h3>
