...
export default function DesktopFrame({ url, children, compact = false }: DesktopFrameProps) {
  return (
    <div className={`rounded-xl border border-slate-300 bg-white shadow-lg overflow-hidden w-full mx-auto ${compact ? 'max-w-[460px]' : 'max-w-[720px]'}`}>
      {/* Browser chrome */}
